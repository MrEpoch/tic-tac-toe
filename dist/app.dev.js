...
var Logic = function Logic() {
  ...
  var StateCheck = function StateCheck() {
    ...
    var tie = round.length === 9 && Winner1 === false && Winner2 === false;
    return {
      Winner1: Winner1,
      Winner2: Winner2,
      tie: tie
  ...
  var StateEffect = function StateEffect() {
    var winP1 = function winP1() {
      ElementLocations.board.innerHTML = "<div class=\"win\"><p>".concat(PlayerNames().playerName.P1, " has won, congratulations!</p><p>X</p></div>");
    };

    var winP2 = function winP2() {
      ElementLocations.board.innerHTML = "<div class=\"win2\"><p>".concat(PlayerNames().playerName.P2, " has won, congratulations!</p><p>O</p></div>");
    };
  ...
  var ReadingArr = function ReadingArr() {
    ...
    var _loop = function _loop(i) {
      positionArr[i].addEventListener("click", function () {
        ...
        console.log(round.length); // There i use StateCheck and StateEffect
